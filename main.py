...
try:
    ...
    exit(1) # Bot will exit if DB connection fails
...
# --- Utility Functions (Ye sab waise hi rahenge) ---
...
# --- Pyrogram Event Handlers (Ye sab waise hi rahenge) ---
...
if __name__ == "__main__":
    ...
    # The 'Procfile' will ensure this runs as a separate process.
    app.run()
